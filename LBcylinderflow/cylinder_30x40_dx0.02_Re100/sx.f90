PROGRAM MAIN
PARAMETER(IM=2251,JM=1501,KM=9)
PARAMETER(ISY=500,ISB=400)
REAL(KIND=8),PARAMETER::LX=40
REAL(KIND=8),PARAMETER::LY=30
INTEGER,PARAMETER::T_PLOT=20000
...
DO I=1,ISY
SX(I)=10.0+0.5*COS(2*PI*(I-1)*1.0/(ISY*1.0))
SXH(I)=SX(I)
SY(I)=10.+0.5*SIN(2*PI*(I-1)*1.0/(ISY*1.0))
SYH(I)=SY(I)
SU(I)=0.0
SV(I)=0.0
SFX(I)=0.0
